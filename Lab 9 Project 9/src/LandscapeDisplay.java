...
public class LandscapeDisplay extends JFrame
{
     ...
     */
    public LandscapeDisplay(Landscape scape, int scale,KeyListener kl)
    {
        // setup the window
        ...
        this.canvas = new LandscapePanel( (int) this.scape.getlength() * this.gridScale,
                                        (int) this.scape.getWidth() * this.gridScale);
