...
public class LinkedList<T> implements Iterable<T> {
	...
	//This will return the head of the list, this will be used to remove costumers if their 
			public T getHead(){
				return this.head.data;//this will return the data stored in the node:the Costumer object
			}
