...
public class LandscapeDisplay extends JFrame
{
     ...
     */
    public LandscapeDisplay(CheckOut scape, int scale)
    {
        // setup the window
        super("Customer Simulation");
        ...
        this.canvas = new LandscapePanel( (int) this.scape.getNumLanes() * this.gridScale,
                                        (int) 40 * this.gridScale);
